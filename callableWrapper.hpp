...
template <unsigned l, typename Callable> static std::optional<Callable> callableHolder;
template <unsigned l, typename Callable> decltype(auto) callableWrapper(Callable&& callable) {
